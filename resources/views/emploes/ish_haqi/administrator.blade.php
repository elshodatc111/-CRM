...
@section('title',  __('emploes_show.ish_haqi') )
@section('content')
<div class="row">
    <div class="col-lg-6">
        <div class="pagetitle">
            <h1>{{ __('emploes_show.ish_haqi') }}</h1>
            <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('emploes_show.ish_haqi') }}</li>
            </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="notes-wrapper" style="max-height: 320px; overflow-y: auto; overflow-x: hidden;min-height:320px;">
                        ...
                        <table class="table table-bordered" style="font-size: 14px;">
                            <tr>
                                <td>{{ __('emploes_show.ish_haqi') }}</td>
                                <td style="text-align: right">{{ number_format($salary['oklad'], 0, '.', ' ') }}</td>
                            </tr>
                            <tr>
                                <td>{{ __('emploes_show.yangi_bola') }}</td>
                                <td style="text-align: right">{{ $salary['new_child'] }}</td>
                            </tr>
                            <tr>
                                <td>{{ __('emploes_show.new_child') }}</td>
                                <td style="text-align: right">{{ number_format($salary['new_child_pay'], 0, '.', ' ') }}</td>
                            </tr>
                            <tr>
                                <td>{{ __('emploes_show.yangi_lead') }}</td>
                                <td style="text-align: right">{{ $salary['new_lead'] }}</td>
                            </tr>
                            <tr>
                                <td>{{ __('emploes_show.new_lead') }}</td>
                                <td style="text-align: right">{{ number_format($salary['new_lead_pay'], 0, '.', ' ') }}</td>
                            </tr>
                            <tr>
                                <th>{{ __('emploes_show.hisoblandi') }}</th>
                                <th style="text-align: right">{{ number_format($salary['oklad']+$salary['new_child']*$salary['new_child_pay']+$salary['new_lead']*$salary['new_lead_pay'], 0, '.', ' ') }} UZS</th>
                            </tr>
                        </table>
                    </div>
                </div>
